...
responsible for determining the valid moves at the current state, and will keep a move log.
"""
...
class GameState:
    ...
    def makeMove(self, move):
        ...
        self.moveLog.append(move)  # Logs the move to undo the move later or keep track
